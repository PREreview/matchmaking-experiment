  ...
  <main>
    ...
    {% if results %}
      ...
      <div class="ask-for-feedback">
        ...
        <p>We're interested in how relevant the results are to you. We're including requests from late 2023 to now.</p>
        <p>The closest match is at the top. We have included ten results. The matching is currently optimized for English.</p>
        <p>We'd love to hear from you. This is an experiment, so all feedback is valuable to us, regardless of whether you found the results relevant or not. We are also keen to know how you chose your input DOIs.</p>
